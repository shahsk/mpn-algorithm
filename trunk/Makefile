...
OBJS = gamma.o Environment.o Obstacle.o MPN2D.o Integrator.o Unicycle.o Build.o 

all: brownianSim test

test: test.cpp $(OBJS) alglib
	g++ `pkg-config --cflags playerc++` test.cpp $(OBJS) $(ALGLIB_USED) -o test `pkg-config --libs playerc++` -lconfig++ -I./ -I./alglib
