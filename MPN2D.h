...
//If any point on the path is within tolerance of goal, return the index of
//that point. Otherwise, return steps.
int truncatePath(double tol,double* goal,double ** path,int steps);
